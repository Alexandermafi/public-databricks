...
# MAGIC %run ../03_extract_functions_res
...
class TestCustomer(NutterFixture):
  ...
  def __init__(self):
    self.customer_table_name = "guillermo.demo.test_customer"
    self.voucher_table_name = "guillermo.demo.test_voucher"
    ...
    create_customer_test("guillermo.demo.test_customer")
    
    NutterFixture.__init__(self)
    
  def assertion_do_vouchers_io(self):
